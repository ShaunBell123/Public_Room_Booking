...
The application will use a use a CI/CD pipeline to automate testing. Currently, the tests are integration tests that utilize a Testcontainer for PostgreSQL.
